...
const Head = () => {
  ...
  const getSearchSuggestions = async (str) => {
    try {
  ...
  return (
    <div className="grid grid-flow-col p-2 h-14 items-center">
      <div className="flex col-span-1 items-center gap-4 pl-3">
        <svg
      ...
      <div className="flex relative col-span-10 items-center justify-center">
        <input
          ...
          type="text"
        />
        <button className="rounded-r-full bg-[#f8f8f8] border-slate-400 h-9 border w-16 pl-5">
          <Icon />
        </button>
        {(suggestions.length>0 && showSuggestions) && <div className="w-[49%] top-[104%] mr-[54px] rounded-lg bg-white shadow-lg absolute">
          <div>
            <ul className="my-2">
